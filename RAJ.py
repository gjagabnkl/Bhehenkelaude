...
def handle_attack_command(message):
    ...
    try:
        ...
        if bot.attack_in_progress:
            bot.send_message(chat_id, "*⚠️ RUK JA LAUDE*\n"  # Busy message
        ...
        bot.send_message(chat_id, "*🖕 SEND ME IP PORT DURATION*\n"  # Ready to launch message
    ...
    try:
        ...
        if len(args) != 3:
            bot.send_message(message.chat.id, "*‼️ ERROR*\n"  # Error message
                                               "* USE THE CORRECT FORMAT *", parse_mode='Markdown')  # Three inputs message
            return
